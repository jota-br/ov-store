...
public class CommonValidation {
    ...
    public static boolean hasValidName(String input) throws ErrorHandling.InvalidInputException {
    ...
    public static boolean hasValidDescription(String input) throws ErrorHandling.InvalidInputException {
